...
config="$HOME/.config/rofi/pallete.rasi"
script_dir="$(cd "$(dirname "$0")" >/dev/null 2>&1 && pwd)"

latte="$wallpapers/latte.png"
frappe="$wallpapers/frappe.png"
macchiato="$wallpapers/macchiato.png"
mocha="$wallpapers/mocha.png"
